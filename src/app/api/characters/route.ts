...
// (Optional) force Node runtime if you prefer (Storage uses Buffer)
...
export async function POST(req: NextRequest) {
  try {
    ...
    const ip =
      ...
      // @ts-ignore (Node runtime exposes req.ip sometimes)
      (req as any).ip ||
      "unknown";
    ...
    // --- Decode PNG and upload to Storage
    ...
    // --- Create initial rating row (1000 W0 L0)
